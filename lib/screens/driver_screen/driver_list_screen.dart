...
import 'package:machine_task_2/screens/driver_screen/widget/delete_show_dialouge_widget.dart';
import 'package:machine_task_2/screens/driver_screen/widget/show_route_dialouge.dart';
...
class _DriverListScreenState extends State<DriverListScreen> {
            ...
            Padding(
              ...
              child: CircleAvatar(
                  ...
                  child: IconButton(
                      onPressed: () {
                        showRouteDialog(
                            context, null, () => driverProvider.fetchDriver());
                      },
                      icon: const Icon(
                        Icons.add,
                        color: Colors.white,
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          showRouteDialog(context, driver,
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          showDeleteConfirmationDialog(
                              context, driver, driverProvider.fetchDriver);
                        },
                      )
                    ],
                  ),
  ...
  // void showRouteDialog(BuildContext context, DriverModels? driver) {

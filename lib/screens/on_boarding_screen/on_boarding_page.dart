...
import 'package:machine_task_2/screens/on_boarding_screen/widgets/build_page_widget.dart';
import 'package:machine_task_2/screens/on_boarding_screen/widgets/circle_boarder_widget.dart';
            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: TextButton(
                      onPressed: () {
                        nextScreen(context, UserSignInPage());
                      },
                      child: Text(
                        'Skip',
                        style: TextStyle(
              ...
              SizedBox(
                ...
                child: PageView(
                  ...
                  children: [
                    buildPage('assets/images/image_2.png',

...
import 'package:machine_task_2/screens/retail_shop/widget/show_route_dialoug.dart';
import 'package:provider/provider.dart';

import 'widget/delete_show_dialouge_widget.dart';
...
class _RetailShopScreenState extends State<RetailShopScreen> {
  ...
  Widget build(BuildContext context) {
    final retailShopProvider = Provider.of<RetailShopProvider>(context);
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            Padding(
              ...
              child: CircleAvatar(
                  ...
                  child: IconButton(
                      onPressed: () {
                        showRouteDialog(context, null,
                            () => retailShopProvider.fetchStore());
                      },
                      icon: const Icon(
                        Icons.add,
                        color: Colors.white,
        ...
        ListView.builder(
          shrinkWrap: true,
          itemCount: retailShopProvider.stores.length,
          itemBuilder: (context, index) {
            final shop = retailShopProvider.stores[index];
            return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 241, 199, 126),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          showDeleteConfirmationDialog(
                              context, shop, retailShopProvider.fetchStore);
                        },
                      )
                    ],
                  ),
  ...
  // void showRouteDialog(BuildContext context, StoreModels? store) {
  ...
  // void showDeleteConfirmationDialog(BuildContext context, StoreModels store) {
  //   showDialog(
  //     context: context,
